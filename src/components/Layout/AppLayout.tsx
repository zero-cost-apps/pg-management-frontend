    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans text-slate-900">
          ...
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            >
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-[10px] text-slate-400 font-medium leading-none mt-0.5">Enterprise Multi-Property</p>
              </div>
            </div>
                  ...
                  <>
                    ...
                    <div className="absolute right-0 mt-2 w-72 bg-white rounded-2xl border border-slate-200 shadow-xl p-3 z-50 animate-in fade-in-50 zoom-in-95">
                      ...
                      >
                        ...
                        <span>Sign Out of StaySync</span>
                      </button>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        `}>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {item.badge && (
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold ${
                          isActive ? 'bg-indigo-700 text-indigo-100' : 'bg-slate-800 text-emerald-400'
                        }`}>
                          {item.badge}
                        </span>
                      )}
          ...
          <div className="mx-3 mb-2 p-3 rounded-xl bg-gradient-to-br from-indigo-950/70 via-slate-900 to-slate-900 border border-indigo-900/60 shadow-xs">
